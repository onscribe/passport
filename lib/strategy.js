...
function Strategy(options, verify) {
	options = options || {};
	options.authorizationURL = options.authorizationURL || 'https://onscri.be/oauth/authorize';
	options.tokenURL = options.tokenURL || 'https://onscri.be/oauth/token';
...
Strategy.prototype.userProfile = function(accessToken, done) {
	this._oauth2.get('https://onscribe/api/v1/account/info', accessToken, function (err, body, res) {
